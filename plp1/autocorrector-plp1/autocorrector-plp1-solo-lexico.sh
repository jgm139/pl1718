...
# autocorrector para probar solamente el analizador léxico (necesita el fichero testLexico.java)

MAXTIME=15 	    # Tiempo máximo de ejecución (en segundos) de una prueba
PRINCIPAL=testLexico      # Nombre del ejecutable para probar el A.L.
ENT=fuentes	    # Directorio con los ficheros de pruebas de entrada
SAL=salida-esperada-lexico # Directorio con los ficheros de salida correctos del analizador léxico
...
echo "*********************************************************"
echo "Autocorrector plp1 (solo analizador léxico) "
